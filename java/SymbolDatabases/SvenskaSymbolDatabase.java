...
public class SvenskaSymbolDatabase extends BrailleSymbolDatabase
{
	...
	public static final BrailleSymbolType SHORT_2C = new BrailleSymbolType(R.string.symbol_short2c, R.string.symbol_short2c_desc, "SHORT_2C");
	public static final BrailleSymbolType FOREIGN = new BrailleSymbolType(R.string.symbol_foreign, R.string.symbol_foreign_desc, "FOREIGN");

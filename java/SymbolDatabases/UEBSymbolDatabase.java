...
public class UEBSymbolDatabase extends BrailleSymbolDatabase
{
	...
	public static final BrailleSymbolType FINALLETTERCONTRACTION = new BrailleSymbolType(R.string.symbol_finallettercontraction, R.string.symbol_finallettercontraction_desc, "FINALLETTERCONTRACTION");
	public static final BrailleSymbolType SHORTFORM = new BrailleSymbolType(R.string.symbol_shortform, R.string.symbol_shortform_desc, "SHORTFORM");
	...
	private static final BrailleSymbolDataEntry[] allSymbols = {
			...
			new BrailleSymbolDataEntry("about", STANDALONE, SHORTFORM, SHOW_USAGE_RULE, BrailleCellDatabase.Cell1, Cell12),
			new BrailleSymbolDataEntry("above", STANDALONE, SHORTFORM, SHOW_USAGE_RULE, BrailleCellDatabase.Cell1, Cell12, Cell1236),
			new BrailleSymbolDataEntry("according", STANDALONE, SHORTFORM, SHOW_USAGE_RULE, BrailleCellDatabase.Cell1, Cell14),
			new BrailleSymbolDataEntry("across", STANDALONE, SHORTFORM, SHOW_USAGE_RULE, BrailleCellDatabase.Cell1, Cell14, Cell1235),
			new BrailleSymbolDataEntry("after", STANDALONE, SHORTFORM, SHOW_USAGE_RULE, BrailleCellDatabase.Cell1, Cell124),
			new BrailleSymbolDataEntry("afternoon", STANDALONE, SHORTFORM, SHOW_USAGE_RULE, BrailleCellDatabase.Cell1, Cell124, Cell1345),
			new BrailleSymbolDataEntry("afterward", STANDALONE, SHORTFORM, SHOW_USAGE_RULE, BrailleCellDatabase.Cell1, Cell124, Cell2456),
			new BrailleSymbolDataEntry("again", STANDALONE, SHORTFORM, SHOW_USAGE_RULE, BrailleCellDatabase.Cell1, Cell1245),
			new BrailleSymbolDataEntry("against", STANDALONE, SHORTFORM, SHOW_USAGE_RULE, BrailleCellDatabase.Cell1, Cell1245, Cell34),
			new BrailleSymbolDataEntry("also", STANDALONE, SHORTFORM, SHOW_USAGE_RULE, BrailleCellDatabase.Cell1, Cell123),
			new BrailleSymbolDataEntry("almost", STANDALONE, SHORTFORM, SHOW_USAGE_RULE, BrailleCellDatabase.Cell1, Cell123, Cell134),
			new BrailleSymbolDataEntry("already", STANDALONE, SHORTFORM, SHOW_USAGE_RULE, BrailleCellDatabase.Cell1, Cell123, Cell1235),
			new BrailleSymbolDataEntry("altogether", STANDALONE, SHORTFORM, SHOW_USAGE_RULE, BrailleCellDatabase.Cell1, Cell123, Cell2345),
			new BrailleSymbolDataEntry("although", STANDALONE, SHORTFORM, SHOW_USAGE_RULE, BrailleCellDatabase.Cell1, Cell123, Cell1456),
			new BrailleSymbolDataEntry("always", STANDALONE, SHORTFORM, SHOW_USAGE_RULE, BrailleCellDatabase.Cell1, Cell123, Cell2456),
